...
print("El area del cuadrado realizado con el operador multiplicacion es :", area_cuadrado)
...
print("El area del cuadrado realizado con la operador potencia es:", area_cuadrado)
...
print("El area del cuadrado realizado con la operador pow es:", area_cuadrado)
...
print("La cantidad a comprar es de :", cantidad_a_comprar)
