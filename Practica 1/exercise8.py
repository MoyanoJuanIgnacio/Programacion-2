...
lista_1 = ["cafetera", "TV 50 pulgads", "mouse gamer"]
lista_2 = ["ipad", "ipod", "iphone"]
lista_3 = ["Reproductor de CD", "Videograbadora"]
Compras = {
            "Mario Pedernera" : lista_1[:],
            "Ezequiel Castello" : lista_2[:],
            "Pablo Piristrelli" : lista_3[:],
        }
