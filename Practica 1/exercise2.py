...
area_mayor_a_cinco = not(lado_cuadrado <= 2  and area_cuadrado < 5)  
...
resultado = numero_1 % 7 == 0 and numero_2 != 0
print(resultado) 
...
resultado =    variable_03 or variable_02 or variable_04 or variable_05 or not variable_01
print(resultado)
